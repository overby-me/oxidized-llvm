...
against upstream's own `opt -S`, and **151 of 221** are identical, with
three more suites measured the same way: **60 of 71** in `Feature`, **174 of
219** in `Linker` and **129 of 144** in `Other`. Five of the
