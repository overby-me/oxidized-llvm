...
against upstream's own `opt -S`, and **175 of 221** are identical, with
three more suites measured the same way: **65 of 71** in `Feature`, **201 of
219** in `Linker` and **135 of 144** in `Other`. Twelve of the
sixty-four remaining differences are ones where we already match
