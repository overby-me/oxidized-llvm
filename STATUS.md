...
| Third-party crates | none | The whole workspace has zero dependencies. Adding one is just a `Cargo.lock` change: the cargo builder derives its index from the lock. |
