//! What LangRef says about the intrinsics, in four generated tables.
//!
...
//!
//! All four come from `corpus/intrinsic-names.nu`,
//! `corpus/intrinsic-signatures.nu`, `corpus/intrinsic-overloads.nu` and
//! `corpus/intrinsic-attributes.nu`, which explain their derivations. Each
//! looks itself up through [`candidates`], which is here rather than in a
//! generated file so that regenerating one cannot take it away.
...
#[cfg(test)]
mod tests {
    use super::{attributes, base_name, is_documented, overloads, table};
